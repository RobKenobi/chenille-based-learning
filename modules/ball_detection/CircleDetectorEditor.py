...
class CircleDetectorEditor:
    ...
    def open_editor(self):
        ...
        cv2.createTrackbar("minDist", "TrackBars", self._minDist, 250, empty)
        cv2.createTrackbar("param1", "TrackBars", self._param1, 250, empty)
        cv2.createTrackbar("param2", "TrackBars", self._param2, 250, empty)
        cv2.createTrackbar("minRadius", "TrackBars", self._minRadius, 250, empty)
        cv2.createTrackbar("maxRadius", "TrackBars", self._maxRadius, 250, empty)
        ...
        while True:
            ...
            self._minDist = cv2.getTrackbarPos("minDist", "TrackBars")
            self._param1 = cv2.getTrackbarPos("param1", "TrackBars")
            self._param2 = cv2.getTrackbarPos("param2", "TrackBars")
            self._minRadius = cv2.getTrackbarPos("minRadius", "TrackBars")
            self._maxRadius = cv2.getTrackbarPos("maxRadius", "TrackBars")
            ...
            if cv2.waitKey(1) == ord("e"):
                # Closing windows
                cv2.destroyWindow("TrackBars : Circle detection")
                cv2.destroyWindow("Circle detector")
